...
import imagePostSreetWear from 'assets/images/images-for-post/streetWear.jpeg'
                    ...
                    <Card sx={{ borderRadius: '0', boxShadow: 'none' }}>
                        <CardContent className="post" sx={{ padding: '0' }}>
                            <div className="post-img">
                                <img
                                    src={imagePostSreetWear}
                                    alt=""
                                    className="imagePage"
                                />
                            </div>
                            <div className="post-title">StreetWear</div>
