...
import imagePostJapanCars from 'assets/images/images-for-post/nsx.jpeg'
                    ...
                    <Card sx={{ borderRadius: '0', boxShadow: 'none' }}>
                        <CardContent className="post" sx={{ padding: '0' }}>
                            <div className="post-img">
                                <img
                                    src={imagePostJapanCars}
                                    alt=""
                                    className="imagePage"
                                />
                            </div>
                            <div className="post-title">Classic Japan cars</div>
                                    ...
                                    <CardContent className="post-quote">
                                        ...
                                        >
                                            ...
                                            <Typography
                                                ...
                                                className="quote"
                                            >
                                                "The car has become a piece of
                                                clothing without which we feel
                                                insecure, naked and unfinished."
                                            </Typography>
                                            <Typography
                                                align="center"
